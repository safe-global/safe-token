...
describe("SafeToken - Inactive", async () => {
    ...
    describe("transferFrom", async () => {
        ...
        it('should update allowance on transferFrom emit event on transferFrom', async () => {
            const { token, ownedToken } = await setupTests()
        ...
        it('should not update unlimited allowance on transferFrom emit event on transferFrom', async () => {
            const { token, ownedToken } = await setupTests()
